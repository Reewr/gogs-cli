...
const DEFAULT_DELIMITER = '<!-- EVERYTHING BELOW THIS LINE IS CONSIDERED COMMENTS -->';

class EditorAborted extends errors.GogsCliError {
  constructor(...args) {
    super('Aborted due to empty message from editor', ...args);
  }
}

class EditorNonZeroExitCode extends errors.GogsCliError {
 ...
 * @param {String} [commentDelimiter='']
 * @returns {Promise<String>}
 */
module.exports = function(filetype, comment = '', commentDelimiter = DEFAULT_DELIMITER) {
